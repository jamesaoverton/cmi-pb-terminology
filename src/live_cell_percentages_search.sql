DROP TABLE IF EXISTS live_cell_percentages_search;

CREATE TABLE live_cell_percentages_search (
  id TEXT NOT NULL,
  short_label TEXT,
  label TEXT NOT NULL,
  synonym TEXT,
...
INSERT INTO live_cell_percentages_search (id, short_label, label)
